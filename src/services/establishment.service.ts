...
export class EstablishmentService {
    ...
    private establishments: Establishment[] = [
        ...
        new Establishment('Bar Astor', 'Rua Delfina, 163 - Vila Madalena', '05443- 010', 'b', 'www.barastor.com.br', -23.553993000, -46.694210000, 1138151364, 4.4, 4.5, null, 2, 'A Vila Madalena faz lembrar bar e boemia.Palavras vizinhas, conceitos complementares.Um não vive sem o outro, em qualquer bom lugar do mundo, a qualquer tempo.O passeio vale pelo ambiente de boteco chique, garçons à moda antiga, pelo chopp bem tirado, pelos cocktails perfeitos e por pratos da cozinha boêmia que dão água na boca.', 'bardoastor.jpg',1)
    ]
